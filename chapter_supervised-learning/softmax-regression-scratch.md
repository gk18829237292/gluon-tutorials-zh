...
[
 {
  "data": {
   ...
   "text/plain": "<matplotlib.figure.Figure at 0x7f08bc642ac8>"
  },
  "metadata": {},
...
[
 {
  "name": "stdout",
  "output_type": "stream",
  "text": "Help on method asscalar in module mxnet.ndarray.ndarray:\n\nasscalar() method of mxnet.ndarray.ndarray.NDArray instance\n    Returns a scalar whose value is copied from this array.\n    \n    This function is equivalent to ``self.asnumpy()[0]``. This NDArray must have shape (1,).\n    \n    Examples\n    --------\n    >>> x = mx.nd.ones((1,), dtype='int32')\n    >>> x.asscalar()\n    1\n    >>> type(x.asscalar())\n    <type 'numpy.int32'>\n\n"
 }
]
```
...
[
 {
  "name": "stdout",
  "output_type": "stream",
  "text": "Epoch 0. Loss: 0.815953, Train acc 0.790952, Test acc 0.788184\nEpoch 1. Loss: 0.803519, Train acc 0.791838, Test acc 0.793750\nEpoch 2. Loss: 0.791443, Train acc 0.794919, Test acc 0.795215\nEpoch 3. Loss: 0.782208, Train acc 0.795035, Test acc 0.796387\nEpoch 4. Loss: 0.772383, Train acc 0.797124, Test acc 0.798340\n"
 }
]
```
...
[
 {
  "data": {
   ...
   "text/plain": "<matplotlib.figure.Figure at 0x7f0834cf5160>"
  },
  "metadata": {},
  "output_type": "display_data"
 },
